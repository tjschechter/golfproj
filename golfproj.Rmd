...
```
```{r table_2,echo=F,results='asis'}
xtable(top_var)
```

Now we have a set of variables which are highly correlated with our explanatory variable. Now let's check for collinearity between these variables.
